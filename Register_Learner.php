...
<html>
  <head>
	<title>Learner register Form</title>
    <meta charset="utf-8">
			...
			<div class="content">
				...
				<div class="contentDetails">
					...
					<div class="loginHere">
					  ...
					  <a href="Login_Learner.php" class="loginLink">
						Login here
					  </a>
					</div>
...
if(isset($_POST["reg"])) 	
{
	...
	$result_phone = mysqli_query($connect,"SELECT * FROM learner where learner_phone_number = '$phone'");
	...
	if($conp == $pass)
	{
		...
		else
		{
			...
			$cart = mysqli_fetch_assoc(mysqli_query($connect, "SELECT * FROM learner where learner_email = '$email'"));
			...
			$body = "Congratulations, ".$name."<br>Thanks for creating an account on C-learnY as a learner";
