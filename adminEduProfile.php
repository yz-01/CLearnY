			...
			<?php
				...
				do
				{
					...
					<div class="contentDetails">
						<div>
							<?php echo $row_educator["educator_id"];?>
						</div>
						
						<div class="contentDetailsPro">
							<img src="src/profilepic.png" alt="default profile picture" width="50px" height="50px">
							<div class="contentDetailsProName"><?php echo $row_educator["educator_name"];?></div>
						</div>
						
						<div>
							<?php echo $row_educator["educator_email"];?>
						</div>
						
						<div>
							<?php echo $row_educator["educator_phone_number"];?>
						</div>
						
						<div>
							<?php echo $row_educator["date"];?>
						</div>
						
						<div>
							<?php echo $row_educator["state"];?>
						</div>
						
						<div  class="contentDetailsActions">
					
							<a href="adminEduProfileDetails.php?buy&id= <?php echo $row_educator['educator_id']?>">
					...
					<?php
				}while($row_educator = mysqli_fetch_array($result_educator));
			?>
