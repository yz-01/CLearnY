...
?>
<html>
<title>Admin Educator profile</title>
...
/*------------------------------Start of content------------------------------*/
	...
	.contentTitle{
		display:grid;
		grid-template-columns: 0.2fr 1.5fr 1.2fr 0.6fr 0.5fr 0.5fr 0.3fr 0.3fr;
		color:#D3D3D3;
		font-weight: bold;
		margin-top:20px;
		padding:10px;
	...
	<div class="main">
		...
		<div class="content">
			<div class="contentAdd">
				...
				<a href="adminAddLeaner.php">
					<div class="contentAddNew">
						<i class="fa fa-plus-circle" aria-hidden="true"></i>Add New Learner
					</div>
				</a>
				<div class="contentAddBlank">	
				</div>
			...
			<?php
				$learner = "Select * from learner";
				$result_learner = mysqli_query($connect,$learner);
				...
				do
				{
					...
					<div class="contentDetails">
						<div>
							<?php echo $row_learner["learner_id"];?>
						</div>
						...
						<div class="contentDetailsPro">
							<?php
								...
								$result_img = mysqli_query($connect,"SELECT * FROM learner where image_learner = '$image'");
							...
							?>
							<div class="contentDetailsProName"><?php echo $row_learner["learner_name"];?></div>
						</div>
						...
						<div>
							<?php echo $row_learner["date"];?>
						</div>
						
						<div>
							<?php echo $row_learner["state"];?>
						</div>
						
						<div  class="contentDetailsActions">
					
							<a href="adminLearnerProfileDetails.php?buy&id= <?php echo $row_learner['learner_id']?>">
					...
					<?php
				}while($row_learner = mysqli_fetch_array($result_learner));
			?>
