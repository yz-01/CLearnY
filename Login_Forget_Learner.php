...
{
	$email = $_POST["email"];
	$result_email = mysqli_query($connect,"SELECT * FROM learner where learner_email = '$email'");
	$row_email = mysqli_fetch_assoc($result_email);
	$c_email = mysqli_query($connect,"SELECT learner_id FROM learner where learner_email = '$email'");
	...
	else
	{
			...
			$total = $n + $z + $row_email["learner_id"];
			mysqli_query($connect,"UPDATE learner SET code='$total' where learner_id='$row_email[learner_id]'");
			$subject = "Reset Password ";
			$body = "Your EMAIL ADDRESS is ".$row_email["learner_email"]."<br>Your code is ".$total."";
			...
			swal(
                {
					...
					{
						window.location.href = "Learner_enter_code.php?buy&id=<?php echo $row_email['learner_id']?>";
					});
		</script>
		<?php
	}
