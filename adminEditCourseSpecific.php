			...
			<div class="contentDetails">
				<form name="edudetail" method="POST">
					<div class="contentDetailsArrange">
						...
						<div>
							<input type="text" name="name" size="40" value="<?php echo $row["course_name"];?>"/>
						</div>
						...
						<div>
							<input type="text" name="price" size="40" value="<?php echo $row["course_price"];?>"  />
						</div>
						
						<div >
							<i class="fa fa-id-card" aria-hidden="true"></i>Educator ID
						</div>
						<div>
							<input type="text" name="id" size="40" value="<?php echo $row["educator_id"];?>" required disabled />
						</div>
...
if(isset($_POST["submit"])) 	
{
	...
	mysqli_query($connect,"UPDATE course SET course_name='$lname', course_price='$price', state='$sta' where course_id='$row[course_id]'");
	?>
	<script>
				swal(
					{
					...
					{
						window.location.href = "adminVideo.php";
					});
	</script>
	<?php
}																																																																																																										
