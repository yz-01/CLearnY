...
?>
<html>
<title>Admin Add Educator profile</title>
					...
					<div class="contentDetailsArrange2">
						...
						<div class="contentDetailsArrange2Button">
							...
							<div class="contentDetailsArrange2ButtonSubmit">
								<input type="submit" name="submit" value="Add Educator" />
							</div>
						</div>
...
if(isset($_POST["submit"])) 	
{
	...
	$result_email = mysqli_query($connect,"SELECT * FROM educator where educator_email = '$lemail'");
	$count_email = mysqli_num_rows($result_email);
	$result_phone = mysqli_query($connect,"SELECT * FROM educator where educator_phone_number = '$lphone'");
	...
	if($conp == $lpassword)
	{
		...
		else
		{
			...
			$wallet = mysqli_fetch_assoc(mysqli_query($connect, "SELECT * FROM educator where educator_name = '$lname'"));
